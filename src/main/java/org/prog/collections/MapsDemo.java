...
public class MapsDemo {
    ...
    private static void printCarOwner() {
        HashMap<Car,String > ownedCars = new HashMap<>();
        ownedCars.put(new Car(CarOwner.John), "Black");
        ownedCars.put(new Car(CarOwner.John), "White");
        ownedCars.put(new Car(CarOwner.John), "Green");
        ownedCars.put(new Car(CarOwner.Alice), "Red");
        ownedCars.put(new Car(CarOwner.Alice), "Black");
        ownedCars.put(new Car(CarOwner.Alice), "White");
    }
}